...
const navItems: NavItem[] = [
  ...
  { label: "Configuraci髇", href: "/app/configuracion", icon: Settings },
];
...
export function LeftSidebar({ session, onSignOut }: LeftSidebarProps) {
  ...
  return (
    <aside className="md:fixed md:inset-y-0 md:left-0 md:z-20 md:flex md:w-[260px] md:flex-col md:border-r md:border-line md:bg-surface md:px-4 md:py-5">
      ...
      {/* Mobile nav */}
      <nav className="border-b border-line bg-surface px-4 py-2 md:hidden" aria-label="Navegaci贸n m贸vil">
      ...
      <div className="hidden md:flex md:flex-1 md:flex-col">
        ...
        {/* Nav */}
        <nav aria-label="Navegaci贸n principal" className="flex-1">
